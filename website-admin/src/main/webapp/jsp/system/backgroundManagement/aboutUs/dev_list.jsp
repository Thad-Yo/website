...
<tiles:insertTemplate template="/jsp/layout/mainLayout.jsp" flush="true">
                    ...
                    <div class="ibox m0 mt10">
                       ...
                       <div class="ibox-content mb10 search-panel">
                            <form id="searchForm" class="form-inline m0 search-content">
                                ...
                                <div class="pl10 pb10 form-group">
                                    <label class="control-label">历程日期：</label>
                                        <input type="text" name="devDate" id="devDate" class="input-sm form-control" value="" >
                                </div>
                        ...
                        <thead>
	                        <tr>
	                            ...
	                            <!-- <th data-field="imgAddress" data-formatter="ActionEvents.imgFormatter">历程图片</th> -->
    ...
    <tiles:putAttribute name="pageJavaScript" type="string">
        ...
        <jsp:include page="dev_list.js.jsp"/>
    </tiles:putAttribute>
