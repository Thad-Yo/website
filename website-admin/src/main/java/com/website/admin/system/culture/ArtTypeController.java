 ...
 */
@Controller
@RequestMapping(value="/system/artTypeController")
public class ArtTypeController {
    ...
    public ModelAndView init(@ModelAttribute(BaseDefine.FORM) WebsiteCultureType form) {
        ModelAndView modelAndView = new ModelAndView("system/culture/artGuide/art_type_list");
        return modelAndView;
    }
    ...
    private JSONObject createPage(HttpServletRequest request, WebsiteCultureType form) {
        ...
        form.setCultureTypeCode(ConstantsUtil.CULTURE_ART);
    ...
    public ModelAndView info(HttpServletRequest request, @ModelAttribute(BaseDefine.FORM) WebsiteCultureType form) {
        ModelAndView modelAndView = new ModelAndView("system/culture/artGuide/art_type_info");
