    ...
    /* 事件 */
            Events = {
                addAction: function () {
                    layerIndex = layer.open({
                        ...
                        area: ['850px', '550px'],
                        maxmin: true,
                        content: [webRoot + '/system/enterprise/infoAction']
                    });
                ...
                modifyAction: function (selects) {
                    ...
                    layerIndex = layer.open({
                        ...
                        area: ['800px', '500px'],
                        maxmin: true,
                        content: [webRoot + '/system/enterprise/infoAction?id=' + selects[0].id+'&cnEnFlag='+cnEnFlag+'&hasEnFlag='+selects[0].hasEnFlag]
                    });
                    layer.full(layerIndex);//全屏幕显示
                },
                ...
                removeAction: function(selects){
                    ...
                    Common.confirm("删除", "确认要删除吗？", function (isConfirm) {
                        if (isConfirm) {
                            $.ajax({
                                type: "POST",
                                url: webRoot + "/system/enterprise/removeOrderAction.json",
            ...
            ActionEvents = {
                ...
                actionFormatter: function (value, row) {
                    ...
                    <shiro:hasPermission name="enterprise:EDITEN">
                    if (row.hasEnFlag == "0") {
