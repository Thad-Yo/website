    ...
    /* 事件 */
            Events = {
                addAction: function () {
                    layerIndex = layer.open({
                        ...
                        area: ['850px', '550px'],
                        maxmin: true,
                        content: [webRoot + '/system/donation/infoAction']
                    });
                ...
                modifyAction: function (selects) {
                    ...
                    layerIndex = layer.open({
                        ...
                        area: ['800px', '500px'],
                        maxmin: true,
                        content: [webRoot + '/system/donation/infoAction?id=' + selects[0].id+'&cnEnFlag='+cnEnFlag+'&hasEnFlag='+selects[0].hasEnFlag]
                    });
                    layer.full(layerIndex);//全屏幕显示
                },
                ...
                tableParams: function (params) {
                    ...
                    params.donationTime = $("#donationTime").val();
            ...
            ActionEvents = {
                ...
                actionFormatter: function (value, row) {
                    ...
                    <shiro:hasPermission name="donation:DELETE">
