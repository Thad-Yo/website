...
<script>
    ...
    /* 事件 */
    		...
    		upLoadImage: function($upLoadId,$image,$imgAdress){
                ...
                },titleCnCheck:function(){
                	if($("#titleCn").val() != ""){
                		if($("#titleCn").val().length > 20){
                			$("#titleCnCheck").text("最多输入20位字符").val('validError');	
                			$("#titleCnCheck").removeClass("Validform_right");
                			$("#titleCnCheck").addClass("Validform_wrong");
                		}else{
                			$("#titleCnCheck").removeClass("Validform_wrong");
                			$("#titleCnCheck").addClass("Validform_right");
                			$("#titleCnCheck").text('输入字数正确').val('');
                		}
                	}
                	
                },titleEnCheck:function(){
                	if($("#titleEn").val() != ""){
                		if($("#titleEn").val().length > 20){
                			$("#titleEnCheck").text("最多输入20位字符").val('validError');	
                			$("#titleEnCheck").removeClass("Validform_right");
                			$("#titleEnCheck").addClass("Validform_wrong");
                		}else{
                			$("#titleEnCheck").removeClass("Validform_wrong");
                			$("#titleEnCheck").addClass("Validform_right");
                			$("#titleEnCheck").text('输入字数正确').val('');
                		}
                	}
    ...
    /* 画面对象 */
            Page = {
                ...
                initEvents: function () {
                    ...
                    $("#titleCn").blur(Events.titleCnCheck);
                    $("#titleEn").blur(Events.titleCheck);
                    Events.upLoadImage("#uploadImg","#imgAddress","#imgUrlCn");
                    Events.upLoadImage("#uploadImg1","#imgAddress1","#imgUrlEn");
                },
