package com.website.common.util.validator;
...
import com.website.common.util.string.CharPool;
import com.website.common.util.string.StringPool;
import com.website.common.util.string.StringUtil;
...
public class Validator {
	 ...
	 * @throws UnsupportedEncodingException
	 */
	public static boolean isAlphabetOrNumeric(char Ch) {
		// 英字判定
	...
	public static boolean isDomain(String domainName) {
		...
		String[] domainNameArray = StringUtils.split(domainName, CharPool.PERIOD);
	...
	public static boolean isHostName(String name) {
		...
		for (char c : nameCharArray) {
			if (!isChar(c) && !isDigit(c) && (c != CharPool.DASH) && (c != CharPool.PERIOD)) {
