...
var ActionEvents = {
        ...
        actionFormatter: function (value, row) {
            ...
            <shiro:hasPermission name="company:DELET">
            </shiro:hasPermission>
	...
	Events = {
		addAction:function (selects,flag) {
            layerIndex = layer.open({
                ...
                area: ['800px', '400px'],
                maxmin: true,
                content: [webRoot + '/system/backgroundManageMent/filialeController/addInfo?'+"&isEng="+flag]
            });
		...
		editAction:function (selects,flag) {
            layerIndex = layer.open({
                ...
                area: ['800px', '400px'],
                maxmin: true,
                content: [webRoot + '/system/backgroundManageMent/filialeController/editInfo?id='+selects[0].id+"&isEng="+flag]
            });
            layer.full(layerIndex);
        },
        ...
        tableParams: function (params) {
        	params.filialeName = $("#filialeName").val();
       		params.tel = $("#tel").val();
