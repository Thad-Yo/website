 ...
 */
@Controller
@RequestMapping(value="/system/artGuideController")
public class ArtGuideController {
	@Autowired
    ...
    public ModelAndView init(@ModelAttribute(BaseDefine.FORM) WebsiteOurStaff form) {
        ModelAndView modelAndView = new ModelAndView("system/culture/artGuide/art_guide_list");
        return modelAndView;
    }
    ...
    private JSONObject createPage(HttpServletRequest request, WebsiteOurStaff form) {
        ...
        form.setTypeCode(ConstantsUtil.CULTURE_ART);
    ...
    public ModelAndView info(HttpServletRequest request, @ModelAttribute(BaseDefine.FORM) WebsiteOurStaff form) {
        ModelAndView modelAndView = new ModelAndView("system/culture/artGuide/art_guide_info");
        ...
        type.setCultureTypeCode(ConstantsUtil.CULTURE_ART);
