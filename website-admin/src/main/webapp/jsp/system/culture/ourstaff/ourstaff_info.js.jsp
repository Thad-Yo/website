    ...
    /* 事件 */
            Events = {
                ...
                saveAction: function () { 
                    ...
                    if (Page.validform.check() && !($(".Validform_wrong").length > 0)) {
                        ...
                        Common.confirm("保存", "确认要保存这条信息吗？", function (isConfirm) {
                            if (isConfirm) {
                                ...
                                formData.push({
                                    "name": "imgTypeName",
                                    "value": $("#imgType option:selected").text()
                                });
                                formData.push({
                                    "name": "imgTypeEnName",
                                    "value": $("#imgType option:selected").attr("enName")
                                });
                	...
                	if($("#imgDesc").val() != ""){
                		if(cnEnFlag == "0"){
                			if($("#imgDesc").val().length > 10){
                    			$("#titleCheck").text("最多输入10位字符").val('validError');	
                			...
                			if($("#imgDesc").val().length > 20){
                    			$("#titleCheck").text("最多输20位字符").val('validError');	
                    			$("#titleCheck").removeClass("Validform_right");
                    			$("#titleCheck").addClass("Validform_wrong");
                    		}else{
                    			$("#titleCheck").removeClass("Validform_wrong");
    ...
    /* 画面对象 */
            Page = {
                ...
                initEvents: function () {
                    ...
                    $("#imgDesc").blur(Events.titleCheck);
