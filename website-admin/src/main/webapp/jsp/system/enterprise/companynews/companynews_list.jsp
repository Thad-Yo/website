...
<tiles:insertTemplate template="/jsp/layout/mainLayout.jsp" flush="true">
                        ...
                        <div class="ibox-content mb10 search-panel">
                            <form class="form-inline m0 ">
                                ...
                                <div class="pl10 pb10 form-group">
                                    ...
                                    <input type="text" name="publishTime" id="publishTime" class="input-sm form-control" value="" >
                                </div>
                                <div class="pl10 pb10 form-group">
                                    ...
                                    <div class="input-group" style="width: 200px;">
                                        <select id="type" name="type" class="form-control">
                                            ...
                                            <option value="0">联信时讯</option>
                                            <option value="2">联信Style</option>
                                         </select>
                                    </div>
                                </div>
                                <div class="pl10 pb10 form-group">
                            ...
                            <table id="listTable" data-height="505" data-mobile-responsive="true"
                             style="width: 100%; table-layout: fixed;word-break: break-all; word-wrap: break-word;" data-sort-name="creat_date" data-height="100%" data-sort-order="desc">
                                ...
                                <tr>
                                    ...
                                    <th data-align="center" data-width="200px" data-field="coverPageUrl" data-sortable="false" data-formatter="ActionEvents.imgFormatter">图片</th>
                                    <th data-align="center" data-width="150px" data-field="newsTitle" data-sortable="false">标题</th>
                                    <th data-align="center" data-width="80px" data-field="publishTime" data-sortable="false">发布时间</th>
                                    <th data-align="center" data-width="150px" data-field="type" data-sortable="false" data-formatter="ActionEvents.typeAction">类型</th>
                                    ...
                                    <th data-align="center" data-width="80px" data-field="updateTime">编辑日期</th>
    ...
    <script type="text/javascript" src="${webRoot}/js/plugins/laydate/laydate.js"></script>
        <jsp:include page="companynews_list.js.jsp"/>
    </tiles:putAttribute>
