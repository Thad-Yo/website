...
<tiles:insertTemplate template="/jsp/layout/mainLayout.jsp" flush="true">
    <%-- 画面的标题 --%>
    <tiles:putAttribute name="pageTitle" value="新闻详情"/>
                        ...
                        <div class="ibox-content">
                            <form method="post" class="form-horizontal registerform" id="mainForm">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-2 control-label"><span class="need">*</span>封页</label>
                                    <div class="col-sm-3 control-label" >
                                        ...
                                        <div  class="Validform_checktip">请上传宽324像素*高136像素，分辨率72的图片！</div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3" style="position:relative;">
                                        ...
                                        <div class="lengthR">（最大长度为200个字符！）</div>
                                        <div class="Validform_checktip" id="newsTitleCheck">请输入标题！</div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label"><span class="need">*</span>发布时间</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="publishTime" name="publishTime" maxlength="20" value="${record.publishTime}"/>
                                        <div class="Validform_checktip">请选择发布日期。</div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label"><span class="need">*</span>类型</label>

                                    <div class="col-sm-4">
										<select id="type" name="type" class="form-control" datatype="*">
											<option value="" >请选择</option>
											<option value="0"  <c:if test="${record.type == '0'}">selected</c:if>>联信时讯</option>
                                            <option value="2" <c:if test="${record.type == '2'}">selected</c:if>>联信Style</option>
										</select>

										<div class="Validform_checktip">请选择类型</div>
                                    </div>
                                </div>
                                <div class="form-group">
                                            <label class="col-sm-2 control-label"><span class="need">*</span>置顶首页</label>
                                            <div class="col-sm-9">
                                                <div class="radio clip-radio radio-primary ">
                                                    <input type="radio" id="sexOn" name="isToppp" value="0"  <c:if test="${record.isTop == '0'}">checked</c:if> <c:if test="${record.cnEnFlag == '1'}">disabled </c:if>/>
                                                    <label  for="sexOn">是 </label>
                                                    <input type="radio" id="sexOff" name="isToppp" value="1" <c:if test="${record.isTop == '1'}">checked</c:if> <c:if test="${record.cnEnFlag == '1'}">disabled </c:if>/>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                    	<textarea rows="5" cols="100" id="summary" name="summary" dataType="*">${record.summary}</textarea>
                                        <div class="Validform_checktip summaryCheck" id="summaryCheck">输入摘要！</div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">正文简介</label>
                                    <div class="col-sm-8">
                                    	<textarea rows="5" cols="100" id="mainContent" name="mainContent">${record.mainContent}</textarea>
                                        <div class="maxLengthR">最大长度为200个字符！</div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label"><span class="need">*</span>正文</label>
                                    <div class="col-sm-8">
                                        <script id="content" name="content" type="text/plain"></script>
                                        <div class="Validform_checktip">输入正文！</div>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12 text-center">
                                        ...
                                        <button type="button" class="ml30 btn btn-add btn-lg btn-primary fn-Preview" style="margin-bottom: 15px;"
                                                title="预览">
                                            <i class="fa fa-eye" aria-hidden="true"> 预览</i>
                                        </button>
    ...
    <tiles:putAttribute name="pageJavaScript" type="string">
        ...
        <jsp:include page="companynews_info.js.jsp"></jsp:include>
    </tiles:putAttribute>
