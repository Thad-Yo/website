...
<tiles:insertTemplate template="/jsp/layout/mainLayout.jsp" flush="true">
                    ...
                    <div class="ibox m0 mt10">
                       ...
                       <div class="ibox-content mb10 search-panel">
                            <form id="searchForm" class="form-inline m0 search-content">
                                ...
                                <div class="pl10 pb10 form-group">
                                    <label class="control-label">荣誉年份：</label>
                                        <input type="text" name="honorNumber" id="honorNumber" class="form-control form-filter " value="" >
                                </div>
                                <div class="pl10 pb10 pull-right">
                                    <div class="pl10 pb10 form-group pull-right">
                                        ...
                                        <shiro:hasPermission name="honor:NEW">
                        ...
                        <thead>
	                        <tr>
	                            ...
	                            <th data-field="imgAddress" data-formatter="ActionEvents.imgFormatter">荣誉配图</th>
	                            <th data-field="honorNumber" data-align="center" data-sortable="true">荣誉归属年份</th>
	                            <th data-field="honorName" data-align="left" data-sortable="true" >荣誉名称</th>
	                            <!-- <th data-field="honorState" data-align="center" data-sortable="true">颁奖单位</th> -->
    ...
    <script type="text/javascript" src="${webRoot}/js/plugins/laydate/laydate.js"></script>
        <jsp:include page="honor_list.js.jsp"/>
    </tiles:putAttribute>
