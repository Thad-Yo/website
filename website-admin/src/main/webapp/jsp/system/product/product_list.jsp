...
<tiles:insertTemplate template="/jsp/layout/mainLayout.jsp" flush="true">
                            ...
                            <table id="listTable" data-height="505" data-mobile-responsive="true"
                             style="width: 100%; table-layout: fixed;word-break: break-all; word-wrap: break-word;" data-sort-name="creat_date" data-height="100%" data-sort-order="desc">
                                ...
                                <tr>
                                    ...
                                    <th data-align="center" data-width="150px" data-field="title" data-sortable="false">产品服务标题</th>
                                    <th data-align="center" data-width="150px" data-field="summary" data-sortable="false" data-formatter="">摘要</th>
                                    <th data-align="center" data-width="150px" data-field="content" data-sortable="false" data-formatter="">简介</th>
    ...
    <tiles:putAttribute name="pageJavaScript" type="string">
        <jsp:include page="product_list.js.jsp"/>
    </tiles:putAttribute>
