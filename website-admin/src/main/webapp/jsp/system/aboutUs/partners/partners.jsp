...
<tiles:insertTemplate template="/jsp/layout/mainLayout.jsp" flush="true">
    	...
    	<div class="wrapper wrapper-content  fadeInRight">
    		<div class="row">
                <div class="panel-body">
                    ...
                    <div class="input-group" style="width: 700px;">
                        <span class="input-group-btn">
                            <button type="button" id="imgAllSelect" class="btn btn-danger" style="margin-left: 850px;">全选</button>
                            <shiro:hasPermission name="friend:DELET">
                ...
                <div class="col-sm-12 disTop">
                            ...
                            <div class="file">
                                <div class="action" style="margin: 0px 0px 0px 5px">
                                    <div class="checkbox clip-check check-primary ">
                                        <input type="checkbox" name="${attchment.fileName}" id="image_${attchment.id}" tid="${attchment.id}" value="${attchment.id}" /> <label  for="image_${attchment.id}"> </label>
                                    </div>
                                </div>
                    ...
                    <shiro:hasPermission name="friend:SAVE">
                    <div class="image" style="height: 120px;">
    ...
    <tiles:putAttribute name="pageJavaScript" type="string">
        ...
        <jsp:include page="partners.js.jsp"/>
